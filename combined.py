...
mqtt_pub= mqtt.Client("control1")                           #create client object
mqtt_pub.on_publish = on_publish                          #assign function to callback
mqtt_pub.connect(mqtt_broker,1883)                                 #establish connection
