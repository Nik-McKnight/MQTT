...
4. In a second terminal, navigate to MQTT/publisher, run "apt-get -y update && apt-get install -y libmosquitto-dev", 
   "gcc publisher.c -o publisher -lmosquitto", and finally "./publisher" to start the publisher client.

5. In a third terminal, navigate to MQTT/receiver, run "pip install paho-mqtt", "pip install geopy",
